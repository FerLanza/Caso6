...
Bird.prototype.update_position = function(elapsed_time, lookAt) {
	...
	if (elapsed_time/1000 < .5) {
		...
		console.log(this.id+ " ");
		console.log((this.velocity.x + this.velocity.y + this.velocity.z)/3 + " "); //Promediado de velocidades 
		console.log(Math.sqrt(Math.pow(displacement.x,2)+Math.pow(displacement.y , 2)+ Math.pow(displacement.z,2))+ " ");
